...
![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide1.PNG)

# GitHub

![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide2.PNG)

# The context

![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide3.PNG)
...
![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide4.PNG)
...
![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide5.PNG)
...
![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide6.PNG)
...
<!-- A multiple number of individual workflows was collected. However, it was not easy to get the full picture. You can see that the heterogeneity is big across country workflows. -->
...
# visSave(my_visnet, file = "20211123_uROS_2021.html")
...
<!-- Moreover, hoovering the mouse over a node shows additional information -->
...
<!-- Let say that one want to select a group or topic. Let us choose “web scraped data”. (Notice: the bigger a node, the more countries envolved using these data. Moreover look that the colour of the lines depict the predominant connection to a node.) -->
<!-- 1. We can see “which sources” were scraped, namely hotels.com, booking and airbnb. -->
<!-- 2. If you wonder “How many countries use booking?”, just hoover on the node. There are 7 countries collecting hotels.com data. -->
<!-- (To what results?) -->
<!-- 3. You may guess t he purpose of use of these data in terms of official statistics, i.e. improving the accommodation inventory but also to learn more about visitors  -->
...
<!-- Let us now select an output  node: Improve the quality of tourist expenses data.  (Notice again: the bigger a node, the more countries envolved using these data. All countries have a survey on visitor expenditures and a survey on participation of residents in trips.) -->
...
![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide10.PNG)
...
<!-- Nodes table has numeric ID of the nodes and their properties: size, shape, colour. It also has label, title (provide the tooltip info when hoovering over a node) and group that have the data to use in the combo boxes. In this case, size indicates the number of countries that use that particular data source, for example. -->

<!-- Edges table has information on the connections (“from” and “to”) and also on length, width and arrow type. The ID’s for the “from” and “to” are the same as node’s ID. -->


# How does it work? The Script

![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide11.PNG)

<!-- The next thing was to create a script to produce a dynamic and interactive network. -->
<!-- We used the visNetwork package visNetwork package3, an R interface to “vis.js” JavaScript library. Although it is not mandatory to know JavaScript to use this package, some basic knowledge is helpful for some functionality  such  as  action  related  events.   -->
<!-- The  visNetwork  is  very  flexible  and  accessible  not  only because it is based on open-source software, but also because it works on any modern browser for up  -->
...
```
<!-- Now,  I’d like to share with you this very useful command (visNetworkEditor) that needs shiny package and lets you configure and view options directly and imediatly on your network . -->

<!-- And without writing a single line of code. -->

<!-- LIVE DEMO: -->

<!-- You just change some parameters (check boxes and slidders) and you imediatly see the result. Onde you’re satisfied with the result, just use it on your script. -->



# R Packages

![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide13.PNG)
...
![](C:/Users/rui.alves/Documents/uRos2021/20211123_uROS_2021/Slide14.PNG)
